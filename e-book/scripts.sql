...
DROP TABLE IF EXISTS PUBLIC.BOOK_ORDER_HEADER;

CREATE TABLE PUBLIC.BOOK_ORDER_HEADER (
	ID BIGINT PRIMARY KEY AUTO_INCREMENT,
	CUSTOMER_ID INT NOT NULL,
	TRACKING_NUMBER VARCHAR(255) NOT NULL,
	TOTAL_PRICE DOUBLE NOT NULL,
	ORDER_DATE TIMESTAMP NOT NULL DEFAULT SYSDATE
);

DROP TABLE PUBLIC.BOOK_ORDER_DETAIL;

CREATE TABLE PUBLIC.BOOK_ORDER_DETAIL (
	ID BIGINT PRIMARY KEY AUTO_INCREMENT,
	ORDER_ID BIGINT NOT NULL,
	BOOK_ID INT NOT NULL,
	ORDERED INT NOT NULL,
	FOREIGN KEY (BOOK_ID) REFERENCES PUBLIC.BOOK(ID),
	FOREIGN KEY (ORDER_ID) REFERENCES PUBLIC.BOOK_ORDER_HEADER(ID)
);

INSERT INTO PUBLIC.BOOK_ORDER_HEADER(CUSTOMER_ID, TRACKING_NUMBER, TOTAL_PRICE) VALUES (100,'TEST123',120.00);

INSERT INTO PUBLIC.BOOK_ORDER_DETAIL (ORDER_ID,BOOK_ID) VALUES (1,1);
INSERT INTO PUBLIC.BOOK_ORDER_DETAIL (ORDER_ID,BOOK_ID) VALUES (1,2);


CREATE TABLE PUBLIC.ROLE (
	ID BIGINT PRIMARY KEY AUTO_INCREMENT,
	ROLE VARCHAR(255) NOT NULL,
	CREATED_DTM TIMESTAMP NOT NULL DEFAULT SYSDATE
);

INSERT INTO PUBLIC.ROLE (ROLE) VALUES ('Admin');
INSERT INTO PUBLIC.ROLE (ROLE) VALUES ('Regular-User');
...
CREATE TABLE PUBLIC.USER_ROLE (
    ...
    CONSTRAINT UNIQUE_EMAIL_ROLE UNIQUE (USER_EMAIL, ROLE_ID)
);	

INSERT INTO PUBLIC.USER_ROLE (USER_EMAIL, ROLE_ID) VALUES ('kaushikc10@jwt-test.com', 1);
INSERT INTO PUBLIC.USER_ROLE (USER_EMAIL, ROLE_ID) VALUES ('bryanG@jwt-test.com', 1);
INSERT INTO PUBLIC.USER_ROLE (USER_EMAIL, ROLE_ID) VALUES ('MichaelS@gmail.com', 2);
INSERT INTO PUBLIC.USER_ROLE (USER_EMAIL, ROLE_ID) VALUES ('XinZong@gmail.com', 2);
INSERT INTO PUBLIC.USER_ROLE (USER_EMAIL, ROLE_ID) VALUES ('KassieK@hotmail.com', 2);



ALTER TABLE "USER" 
ADD CREATED_ON TIMESTAMP DEFAULT(SYSDATE);
